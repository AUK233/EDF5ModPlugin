...
movss dword ptr [rdi+14E4h], xmm0 ;g
movsxd rax, dword ptr [rcx+8]
movss xmm0, dword ptr [rax+rcx+32]
movss dword ptr [rdi+14E8h], xmm0 ;b
movsxd rax, dword ptr [rcx+8]
movss xmm0, dword ptr [rax+rcx+44]
movss dword ptr [rdi+14ECh], xmm0 ;a

;mov dword ptr [rdi+14E0h], 3F800000h
;mov dword ptr [rdi+14E4h], 3F800000h
;mov dword ptr [rdi+14E8h], 41200000h
;mov dword ptr [rdi+14ECh], 3F800000h
